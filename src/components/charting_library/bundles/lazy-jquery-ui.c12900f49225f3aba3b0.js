                  ...
                  _updateDatepicker: function (i) {
                    ...
                    a.length > 0 && n.apply(a.get(0)),
                      i.dpDiv
                        ...
                        .width(''),
                      r > 1 &&
                        i.dpDiv.addClass('ui-datepicker-multi-' + r).css('width', 17 * r + 'em'),
                  ...
                  drag: function (e, i, s) {
                    ...
                    for (d = s.snapElements.length - 1; d >= 0; d--)
                      (l = (h = s.snapElements[d].left - s.margins.left) + s.snapElements[d].width),
                        (p =
                          (c = s.snapElements[d].top - s.margins.top) + s.snapElements[d].height),
                        _ < h - g ||
                        m > l + g ||
                        y < c - g ||
                        v > p + g ||
    ...
    k6HY: function (t, e) {
      ($.ui.sortable.prototype._addClass = function (t, e) {
        ...
        ($.ui.sortable.prototype._removeClass = function (t, e) {
          return (
            'string' == typeof t || null === t ? this.element.removeClass(t) : t.removeClass(e),
            this
          );
        });
    },
