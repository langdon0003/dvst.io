        ...
        W = (function (e) {
          function t(t) {
            ...
            var o = r.metaInfo(),
              a = new H.a(o);
            return (
              (n._inputs = a.getStrategyProperties()), (n.state = { currency: n._getCurrency() }), n
            );
          }
          return (
            Object(r.__extends)(t, e),
      ...
      function $(e, t) {
        return (function (e, t) {
          return a.createElement(J.Consumer, null, function (n) {
            return n
              ? a.createElement(e, Object(r.__assign)({}, Object.assign({ model: n }, t)))
              : null;
          });
        })(function (n) {
          var o = n.model;
          ...
          function t() {
            ...
            return (
              ...
              (t._onOpacityChange = function (e) {
                ...
                t._setProperty(
                  n,
                  Object(Ce.generateColor)(r, Object(Ce.alphaToTransparency)(e), !0),
                  xe,
                );
              }),
              (t._onPopupClose = function () {
                t._trackEventLabel &&
                  (Object(d.trackEvent)('GUI', 'Study settings', t._trackEventLabel),
                  (t._trackEventLabel = null));
              }),
              t
            );
          ...
          return (
            ...
            (t.prototype._findPaletteByTargetId = function (e) {
              for (
                ...
                var s = l[a];
                if (
                  (Object(Y.isColorerPlot)(s) || Object(Y.isOhlcColorerPlot)(s)) &&
                  s.target === e
                )
                  return {
                    palette: o[s.palette],
