                        ...
                        void 0 === r && ((r = void 0 === l ? e(o) : e(o, l)), o.data(t, r)),
                          'init' !== n &&
                            ('function' == typeof r[n]
                              ? i(r, n, l)
                              : s.logError(
                                  '[Block Plugin] ' + t + ' does not support command ' + n,
                                ));
                      })
                );
              }
            ...
            function t(e) {
              ...
              if (b) {
                if (!s.is('input[type=checkbox]'))
                  return void r.logError('`$checkbox` need to be input[type=checkbox]');
            ...
            return (
              e <= 0 ||
                ((this._scroll_target_top =
                  o <= 0
                    ? this._header_height
                    : Math.min((-t * i) / e + this._header_height, this._header_height)),
