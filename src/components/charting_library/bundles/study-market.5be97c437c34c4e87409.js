                          ...
                          n.forEach(function (e) {
                            ...
                            return (
                              ...
                              r.toLowerCase() === i.toLowerCase()
                                ? ((s = 3),
                                  void (t =
                                    null === (n = r.match(d)) || void 0 === n ? void 0 : n.index))
                                : d.test(r)
                                ? ((s = 2),
                                  void (t =
                                    null === (a = r.match(d)) || void 0 === a ? void 0 : a.index))
                                : d.test(o)
                                ? ((s = 1),
                                  void (t =
                                    null === (c = r.match(d)) || void 0 === c ? void 0 : c.index))
                                : void (
                                    u.test(o) &&
                                    ((s = 1),
                                    (t =
                                      null === (l = r.match(u)) || void 0 === l ? void 0 : l.index))
                                  )
                            );
                          }),
        ...
        return (
          Object(r.useEffect)(
            function () {
              var e;
              i || d(''),
                E.CheckMobile.any() || null === (e = j.current) || void 0 === e || e.focus();
            },
            [i],
          ),
