  ...
  ['ds-property-pages'],
  {
      ...
      inherit(c, o),
        (c.prototype.prepareLayout = function () {
          ...
          $("<td colspan='7'>").append(T).appendTo(o),
            ...
            this.bindControl(
              new s(T, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
            ),
            this.bindControl(
              new r(
                n,
            ...
            this.bindControl(
              new r(C, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
            ),
            this.bindControl(
              new r(
                y,
      ...
      inherit(p, n),
        ...
        (h.prototype.prepareLayout = function () {
          ...
          this.bindColor(t, c.candleStyle.upColor, 'Change Candle Up Color'),
            ...
            this.bindControl(
              new l(h, c.transparency, !0, this.model(), 'Change Guest Feed Transparency'),
            );
        }),
    ...
    '04K5': function (e, t, i) {
      ...
      inherit(_, a),
        ...
        (_.prototype.getMetaInfo = function (e) {
          for (var t = this._model.m_model._studiesMetaData, i = 0; i < t.length; i++)
        ...
        (_.prototype._prepareSeriesStyleLayout = function (e, t, i, n) {
          ...
          if (this._isShowStyleSwitcher()) {
            ...
            P.addClass('property-wide-select'),
              ...
              $('<option value=' + y.STYLE_CANDLES + '>' + $.t('Candles') + '</option>').appendTo(
                k,
              ),
              $(
                '<option value=' +
              ...
              this._isJapaneseChartsAvailable() &&
                $(
                  '<option value=' + y.STYLE_HEIKEN_ASHI + '>' + $.t('Heikin Ashi') + '</option>',
                ).appendTo(k),
              $('<option value=' + y.STYLE_LINE + '>' + $.t('Line') + '</option>').appendTo(k),
              $('<option value=' + y.STYLE_AREA + '>' + $.t('Area') + '</option>').appendTo(k),
              $('<option value=' + y.STYLE_BASELINE + '>' + $.t('Baseline') + '</option>').appendTo(
                k,
              ),
              this._isHiLoChartsAvailable() &&
                $('<option value=' + y.STYLE_HILO + '>' + $.t('High-Low') + '</option>').appendTo(
                  k,
                ),
              k.css('width', '100px').appendTo(P),
              this.switchStyle(),
              this.bindControl(
                new h(k, n.style, parseInt, !0, this.model(), 'Change Series Style'),
              );
          }
          ...
          $('<td>').append(O).prependTo(M),
            ...
            this.bindControl(
              new c(R, n.candleStyle.upColor, !0, this.model(), 'Change Candle Up Color'),
            ),
            this.bindControl(
              new c(E, n.candleStyle.downColor, !0, this.model(), 'Change Candle Down Color'),
            ),
            this.bindControl(
              new b(O, n.candleStyle.drawWick, !0, this.model(), 'Change Candle Wick Visibility'),
            ),
            this.bindControl(
              new c(F, n.candleStyle.wickUpColor, !0, this.model(), 'Change Candle Wick Up Color'),
            ),
            this.bindControl(
              new c(
                D,
            ...
            this.bindControl(
              new b(A, n.candleStyle.drawBody, !0, this.model(), 'Change Candle Body Visibility'),
            ),
            this.bindControl(
              new b(
                V,
          ...
          if (
            (this.bindControl(
              new c(J, n.barStyle.upColor, !0, this.model(), 'Change Bar Up Color'),
            ),
            this.bindControl(
              new c(ee, n.barStyle.downColor, !0, this.model(), 'Change Bar Down Color'),
            ),
            this.bindControl(
              new b(
                Z,
            ...
            this.bindControl(
              new b(X, n.barStyle.dontDrawOpen, !0, this.model(), 'Change HLC Bars'),
            ),
            ...
            $('<td>').append(re).prependTo(M),
              ...
              this.bindControl(
                new c(ie, n.hiloStyle.color, !0, this.model(), 'Change High-Low Bodies Color'),
              ),
              this.bindControl(
                new b(
                  ae,
              ...
              this.bindControl(
                new b(re, n.hiloStyle.showLabels, !0, this.model(), 'Change Show High-Low Labels'),
              ),
              this.bindControl(
                new c(ne, n.hiloStyle.labelColor, !0, this.model(), 'Change High-Low Labels Color'),
              ),
              this.bindControl(
                new h(
                  le,
          ...
          $(
            '<option value=' + y.STYLE_LINE_TYPE_SIMPLE + '>' + $.t('Simple') + '</option>',
          ).appendTo(he),
            $(
              '<option value=' +
            ...
            $('<option value=' + y.STYLE_LINE_TYPE_STEP + '>' + $.t('Step') + '</option>').appendTo(
              he,
            ),
            he.appendTo(pe);
          ...
          if (
            ...
            this.bindControl(
              new h(se, n.lineStyle.priceSource, null, !0, this.model(), 'Change Price Source'),
            ),
            this.bindControl(
              new h(he, n.lineStyle.styleType, parseInt, !0, this.model(), 'Change Line Type'),
            ),
            this.bindControl(new c(ce, n.lineStyle.color, !0, this.model(), 'Change Line Color')),
            this.bindControl(
              new u(be, n.lineStyle.linewidth, !0, this.model(), 'Change Line Width'),
            ),
            n.haStyle)
          ) {
            ...
            $('<td>').append(ve).prependTo(M),
              ...
              this.bindControl(
                new c(ue, n.haStyle.upColor, !0, this.model(), 'Change Heikin Ashi Up Color'),
              ),
              this.bindControl(
                new c(Ce, n.haStyle.downColor, !0, this.model(), 'Change Heikin Ashi Down Color'),
              ),
              this.bindControl(
                new b(
                  ve,
          ...
          $('<td>').appendTo(M).append(Se),
            ...
            this.bindControl(
              new h(me, n.areaStyle.priceSource, null, !0, this.model(), 'Change Price Source'),
            ),
            this.bindControl(
              new c(fe, n.areaStyle.linecolor, !0, this.model(), 'Change Line Color'),
            ),
            this.bindControl(
              new u(Le, n.areaStyle.linewidth, !0, this.model(), 'Change Line Width'),
            ),
            this.bindControl(
              new c(
                Se,
          ...
          $('<td colspan="3">').appendTo(M).append(xe),
            this.bindControl(
              new h(xe, n.baselineStyle.priceSource, null, !0, this.model(), 'Change Price Source'),
            );
          ...
          $('<td>').appendTo(M).append(Be),
            ...
            this.bindControl(
              new c(Be, n.baselineStyle.topLineColor, !0, this.model(), 'Change Top Line Color'),
            ),
            this.bindControl(
              new u(Pe, n.baselineStyle.topLineWidth, !0, this.model(), 'Change Top Line Width'),
            );
        ...
        inherit(R, o),
            ...
            if (t.enabled('chart_property_page_scales')) {
              ...
              if (
                ...
                ie.push(s(~~te.maxRightOffset())),
                  ie.push(l(0)),
                  this.bindControl(
                    new p(J, te.defaultRightOffsetProperty(), ie, !0, this.model(), 'Right Margin'),
                  );
              }
              ...
              $('<td>').append(this._scaleBindings.alignLabels.control).prependTo(ge),
              ...
              (m = $('<div>').css('min-width', '620px').data('layout-tab', n.TabNames.scales))
                .append(we)
                .append($e),
                (this.scalesTab = m),
            ...
            if (t.enabled('chart_property_page_background')) {
              ...
              if (null !== He) {
                ...
                $('<td colspan="2">').append(Ue).appendTo(je),
                  this.bindControl(
                    new b(Ue, Ne.color, !0, this.model(), 'Change Symbol Watermark Color'),
                  );
              }
          ...
          (R.prototype._bindScaleProperties = function () {
            ...
            (this._scaleBindings.autoScale.binder = new h(
              ...
              function (i) {
                (e = { autoScale: i }),
                  this._undoModel.setPriceScaleMode(e, t._series.priceScale(), this._undoText);
              },
            )),
          ...
          (R.prototype.addTimezoneEditorRow = function (e) {
            ...
            r.appendTo(o),
              this.bindControl(
                new u(r, this._property.timezone, null, !0, this.model(), 'Change Timezone'),
              );
          }),
          ...
          (R.prototype._createStudySessRow = function (e, t, i) {
            ...
            return (
              this.bindControl(
                new h(o, i.visible, !0, this.model(), 'Change ' + t + ' visibility'),
              ),
      ...
      inherit(p, n),
        (p.prototype.prepareLayout = function () {
          ...
          $('<td>').append(o).prependTo(p),
            ...
            this.bindControl(
              new a(i, this._study.properties().font, null, !0, this.model(), 'Change Pivots Font'),
            ),
            this.bindControl(
              new a(
                t,
            ...
            this.bindControl(
              new r(o, this._property.levelsStyle.showLabels, !0, e.model(), 'Show Pivot Labels'),
            );
          ...
          !(function (e, t, i, o) {
            ...
            $('<td>').append(p).appendTo(d),
              e.bindControl(new s(p, i, !0, e.model(), 'Change ' + n + ' color'));
        ...
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          if ((o.appendTo(this._table), e)) {
            ...
            u.appendTo(b),
              u.css('width', '70px'),
              this.bindControl(
                new a(c, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility'),
              ),
          ...
          v.render().appendTo(T),
            ...
            this.bindControl(
              new s(v, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style'),
            ),
            this.bindControl(
              new d(w, t.linewidth, !0, this.model(), 'Change Pitchfork Line Width'),
            );
        }),
        (b.prototype.prepareLayout = function () {
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          $("<td colspan='2'>").append(B).appendTo(n),
            ...
            this.bindControl(
              new l(b, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
            ),
            this.bindControl(
              new l(
                u,
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          h.appendTo(d),
            h.css('width', '70px'),
            this.bindControl(
              new a(s, i.visible, !0, this.model(), 'Change Gann Square Line Visibility'),
            ),
    ...
    '6rcL': function (e, t, i) {
      ...
      inherit(c, o),
        (c.prototype.addLevelEditor = function (e, t, i, o) {
          ...
          T.render().appendTo(w),
            this.bindControl(
              new a(b, t.visible, !0, this.model(), 'Change Gann Fan Line Visibility'),
            ),
            this.bindControl(new r(C, t.color, !0, this.model(), 'Change Gann Fan Line Color', 0)),
            this.bindControl(
              new l(T, t.linestyle, parseInt, !0, this.model(), 'Change Gann Fan Line Style'),
            ),
      ...
      inherit(h, o),
        ...
        (c.prototype.prepareLayout = function () {
          ...
          var s = this._linetool.properties().points[0],
            d = [r(s.price.value())];
          this.bindControl(
            new p(o, s.price, d, !1, this.model(), 'Change ' + this._linetool + ' point price'),
          ),
            this.bindBarIndex(
              s.bar,
              l,
    ...
    'JM7/': function (e, t, i) {
      ...
      i('PVgW'),
        ...
        (C.prototype.prepareLayout = function () {
          ...
          var x = $('<tr>');
          for (var y in ($("<td colspan='4'>" + $.t('Arcs') + '</td>').appendTo(x),
          x.appendTo(k),
          o.arcs._childs)) {
            var B = o.arcs[y],
              P = $('<tr>');
          ...
          this.bindControl(
            new s(D, o.arcsBackground.fillBackground, !0, t, 'Change Gann Square Filling'),
          ),
            this.bindControl(
              new d(
                I,
    ...
    JyhW: function (e, t, i) {
      ...
      inherit(h, n),
        (h.prototype.prepareLayout = function () {
          ...
          this.bindControl(
            new r(e, this._linetool.properties().textColor, !0, this.model(), 'Change Text Color'),
          ),
            this.bindControl(
              new l(
                t,
            ...
            this.bindControl(
              new s(o, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
            ),
            this.bindControl(
              new r(
                n,
            ...
            this.bindControl(
              new d(p, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
            ),
            this.bindControl(
              new d(
                h,
        ...
        inherit(_, s),
          ...
          (_.prototype.prepareControl = function (t, i, o) {
            ...
            if ('resolution' === t.type)
                ...
                (r = (function (e) {
                  return function (t) {
                    ...
                    if (0 === t.indexOf('#')) {
                      ...
                      var r = a.sourceId();
                      if (!r)
                        return void T.logError('Can not get source id for ' + a.metaInfo().id);
                      i = t.replace(/^[^\$]+/, r);
                    }
                    (!~t.indexOf('$') && !~t.indexOf('#')) ||
                      n._study.isStarted() ||
              ...
              (a = $('<input/>')),
                'bool' === t.type ? a.attr('type', 'checkbox') : a.attr('type', 'text');
            return (
              a &&
                (a.appendTo(i),
                a.is(':checkbox') || 'symbol' === t.type || a.css('width', '100px')),
          ...
          (_.prototype.prepareLayoutImpl = function (e, t) {
            ...
            for (var o = this._sortInputs(e.inputs), l = 0; l < o.length; l++) {
              ...
              if (
                ...
                if (s.options)
                  this.bindControl(
                    new u(L, this._property.inputs[w], null, !0, this.model(), T, S, k),
                  );
                  ...
                  this.bindControl(new C(L, this._property.inputs[w], !0, this.model(), T));
                else if ('resolution' === s.type)
                  this.bindControl(
                    new u(L, this._property.inputs[w], n, !0, this.model(), 'Change Interval'),
                  );
            ...
            if (this._property.offset) {
              ...
              (L = this.addOffsetEditorRow(t, F)),
                ...
                this.bindControl(
                  new y(L, this._property.offset.val, x, !1, this.model(), 'Undo ' + F),
                );
            }
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          v.render().appendTo(T),
            this.bindControl(new l(y, t.color, !0, this.model(), 'Change Pitchfork Line Color'), 0),
            this.bindControl(
              new s(v, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfan Line Style'),
            ),
    ...
    NHMx: function (e, t, i) {
      ...
      inherit(h, o),
        (h.prototype.prepareLayout = function () {
          ...
          this.bindControl(
            new r(e, this._linetool.properties().color, !0, this.model(), 'Change Text Color'),
          ),
            this.bindControl(
              new l(
                t,
            ...
            this.bindControl(
              new d(o, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
            ),
            this.bindControl(
              new r(
                n,
            ...
            this.bindControl(
              new a(b, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap'),
            ),
            this.bindControl(
              new a(u, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
            ),
            this.bindControl(
              new a(
                C,
        ...
        (p.prototype.prepareLayout = function () {
          ...
          t.levels._childs)) {
            ...
            (L = $('<td>')).appendTo(h),
              ...
              this.bindControl(
                new a(c, p.visible, !0, this.model(), 'Change Gann Line Visibility'),
              ),
          ...
          t.fanlines._childs)) {
            ...
            (L = $('<td>')).appendTo(g),
              (S = this.createLineWidthEditor()).appendTo(L),
              this.bindControl(
                new a(c, y.visible, !0, this.model(), 'Change Gann Line Visibility'),
              ),
          ...
          var v = $('<tr>');
          for (var n in ($("<td colspan='4'>" + $.t('Arcs') + '</td>').appendTo(v),
          v.appendTo(T),
          t.arcs._childs)) {
            var _ = t.arcs[n],
              m = $('<tr>');
            ...
            (L = $('<td>')).appendTo(m),
              (S = this.createLineWidthEditor()).appendTo(L),
              this.bindControl(
                new a(c, _.visible, !0, this.model(), 'Change Gann Line Visibility'),
              ),
        ...
        (d.prototype.prepareLayout = function () {
          ...
          if (l.enabled('seconds_resolution')) {
            ...
            $('<td>').append(p).appendTo(t),
              this.bindControl(
                new a(o, e.seconds, !0, this.model(), 'Change Line Tool Visibility On Seconds'),
              ),
              this.bindControl(
                new r(
                  d,
          ...
          $('<td>').append(p).appendTo(t),
            this.bindControl(
              new a(h, e.minutes, !0, this.model(), 'Change Line Tool Visibility On Minutes'),
            ),
            this.bindControl(
              new r(
                d,
          ...
          $('<td>').append(p).appendTo(t),
            this.bindControl(
              new a(b, e.hours, !0, this.model(), 'Change Line Tool Visibility On Hours'),
            ),
            this.bindControl(
              new r(
                d,
          ...
          $('<td>').append(p).appendTo(t),
            this.bindControl(
              new a(u, e.days, !0, this.model(), 'Change Line Tool Visibility On Days'),
            ),
            this.bindControl(
              new r(
                d,
          ...
          $('<td>').append(i).appendTo(t),
            this.bindControl(
              new a(C, e.weeks, !0, this.model(), 'Change Line Tool Visibility On Weeks'),
            );
          (t = $('<tr>').css('height', '29px').appendTo(this._block)),
          ...
          $('<td>').append(i).appendTo(t),
            this.bindControl(
              new a(y, e.months, !0, this.model(), 'Change Line Tool Visibility On Months'),
            ),
            this.loadData();
        }),
        (d.prototype.widget = function () {
    ...
    SSqB: function (e, t, i) {
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          v.render().appendTo(T),
            this.bindControl(
              new r(c, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility'),
            ),
            this.bindControl(new l(y, t.color, !0, this.model(), 'Change Pitchfork Line Color', 0)),
            this.bindControl(
              new s(v, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style'),
            ...
            this.bindControl(
              new d(w, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'),
            );
        }),
        (b.prototype.prepareLayout = function () {
          (this._table = $(document.createElement('table'))),
    ...
    To5g: function (e, t, i) {
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          this.bindControl(
            new a(y, _.fillBackground, !0, this.model(), 'Change Parallel Channel Fill Background'),
          ),
            this.bindControl(
              new a(h, _.showMidline, !0, this.model(), 'Change Parallel Channel Show Center Line'),
            ),
            this.bindControl(
              new a(T, _.extendLeft, !0, this.model(), 'Change Parallel Channel Extending Left'),
            ),
            this.bindControl(
              new a(v, _.extendRight, !0, this.model(), 'Change Parallel Channel Extending Right'),
            ),
            this.bindControl(
              new r(o, _.linecolor, !0, this.model(), 'Change Parallel Channel Color'),
            ),
            this.bindControl(
              new l(i, _.linestyle, parseInt, !0, this.model(), 'Change Parallel Channel Style'),
            ),
            this.bindControl(
              new s(t, _.linewidth, !0, this.model(), 'Change Parallel Channel Width'),
            ),
            this.bindControl(
              new r(u, _.midlinecolor, !0, this.model(), 'Change Parallel Channel Middle Color'),
            ),
            this.bindControl(
              new l(
                b,
            ...
            this.bindControl(
              new s(c, _.midlinewidth, !0, this.model(), 'Change Parallel Channel Middle Width'),
            ),
            this.bindControl(
              new r(
                g,
      ...
      inherit(y, n),
        ...
        (g.prototype.prepareLayout = function () {
          ...
          $('<td>').append(f).appendTo(a),
            this.bindControl(
              new h(n, t.linecolor, !0, this.model(), 'Change Risk/Reward line Color'),
            ),
            this.bindControl(
              new c(o, t.linewidth, !0, this.model(), 'Change Risk/Reward line width'),
            ),
            this.bindControl(
              new h(
                s,
            ...
            this.bindControl(
              new b(g, t.fontsize, parseInt, !0, this.model(), 'Change Text Font Size'),
            ),
    ...
    a0Rg: function (e, t, i) {
      ...
      function n() {
        ...
        return (
          $(
            '<option value="' + o.LineStudyPlotStyle.Line + '">' + $.t('Line') + '</option>',
          ).appendTo(e),
          $(
            '<option value="' +
          ...
          $(
            '<option value="' + o.LineStudyPlotStyle.Area + '">' + $.t('Area') + '</option>',
          ).appendTo(e),
          $(
            '<option value="' +
          ...
          $(
            '<option value="' + o.LineStudyPlotStyle.Columns + '">' + $.t('Columns') + '</option>',
          ).appendTo(e),
          $(
            '<option value="' + o.LineStudyPlotStyle.Circles + '">' + $.t('Circles') + '</option>',
          ).appendTo(e),
          e
        );
      }
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          v.render().appendTo(T),
            ...
            this.bindControl(
              new l(w, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'),
            );
        }),
        (b.prototype.prepareLayout = function () {
          (this._table = $(document.createElement('table'))),
    ...
    cqAO: function (e, t, i) {
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          this.bindControl(
            new l(e, this._linetool.properties().color, !0, this.model(), 'Change Text Color'),
          ),
            this.bindControl(
              new r(
                i,
            ...
            this.bindControl(
              new a(n, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
            ),
            this.bindControl(
              new l(
                d,
            ...
            this.bindControl(
              new s(b, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
            ),
            this.bindControl(
              new s(
                u,
    ...
    k7QS: function (e, t, i) {
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t) {
          ...
          return (
            this.bindControl(
              new r(n, e.visible, !0, this.model(), 'Change Fib Retracement Line Visibility'),
            ),
            this.bindControl(
              new s(c, e.color, !0, this.model(), 'Change Fib Retracement Line Color', 0),
            ),
            i
          );
        }),
        (b.prototype.prepareLayout = function () {
          ...
          if (e) {
            ...
            (g = this.createLineWidthEditor()).appendTo(b),
              this.bindControl(
                new l(g, e.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width'),
              );
            var u = $('<td>').appendTo(i);
          ...
          (g = this.createLineWidthEditor()).appendTo(b),
            this.bindControl(
              new l(g, C.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width'),
            );
          var w;
          u = $('<td>').appendTo(y);
          (w = h()).render().appendTo(u),
          ...
          var V = $("<table cellspacing='0' cellpadding='0'>").appendTo(this._div),
            O =
              ((y = $('<tr>').appendTo(V)), $("<input type='checkbox' class='visibility-switch'>"));
          $('<td>').append(O).appendTo(y), this.createLabeledCell($.t('Background'), O).appendTo(y);
          var z = c();
          if (
            ($('<td>').append(z).appendTo(y), this._linetool.properties().fibLevelsBasedOnLogScale)
          ) {
            y = $('<tr>').appendTo(V);
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          $('<td>').append(h).prependTo(b),
            ...
            this.bindControl(
              new a(o, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
            ),
            this.bindControl(
              new a(
                n,
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          if ((w.appendTo(g), !e)) {
            ...
            v.render().appendTo(T),
              this.bindControl(
                new r(v, t.linestyle, parseInt, !0, this.model(), 'Change Fib Circle Style'),
              );
          }
          this.bindControl(new l(c, t.visible, !0, this.model(), 'Change Fib Circle Visibility')),
            this.bindControl(
              new s(y, t.color, !0, this.model(), 'Change Fib Circle Line Color', 0),
            ),
    ...
    o6hY: function (e, t, i) {
      ...
      inherit(x, n),
            ...
            for (o = 0; o < W.length; ++o) {
              ...
              if (!A.isHidden) {
                ...
                if (A.palette) {
                  ...
                  this.createLabeledCell(z, V).appendTo(O).addClass('propertypage-name-label'),
                    O.appendTo(this._table);
        ...
        (x.prototype._prepareOrdersSwitches = function () {
          ...
          return (
            this.bindControl(
              new p(o, c.strategy.orders.visible, !0, this.model(), 'Trades on chart visibility'),
            ),
            this.bindControl(
              new p(r, c.strategy.orders.showLabels, !0, this.model(), 'Signal labels visibility'),
            ),
            this.bindControl(
              new h(r, c.strategy.orders.visible, !0, this.model(), 'Signal labels visibility', !0),
            ),
            this.bindControl(
              new p(d, c.strategy.orders.showQty, !0, this.model(), 'Quantity visibility'),
            ),
            this.bindControl(
              new h(d, c.strategy.orders.visible, !0, this.model(), 'Quantity visibility', !0),
            ),
            e
          );
        }),
        (x.prototype._prepareLayoutForPlot = function (e, t) {
          ...
          if (a) {
            ...
            S.on('change', this._trackPriceLine.bind(this)).appendTo(L),
              ...
              this.bindControl(
                new b(v, o.linewidth, !0, this.model(), l, this._study.metaInfo().isTVScript),
              ),
        ...
        (x.prototype._prepareLayoutForPalette = function (e, t, i, o, n, a) {
          ...
          for (var y in i.colors) {
            ...
            if (
              ...
              L.appendTo(f),
                this.bindControl(
                  new b(L, g.width, !0, this.model(), n, this._study.metaInfo().isTVScript),
                );
              var S = $('<td>');
              if ((S.appendTo(w), 0 === u)) {
                var k = _();
                k.appendTo(S),
                  this.bindControl(new d(k, s.plottype, parseInt, !0, this.model(), n));
                var x = $('<td>');
                x.appendTo(w);
                var B = $("<input type='checkbox'>");
        ...
        (x.prototype._findPlotPalette = function (e, t) {
          ...
          if (this._study.isBarColorerPlot(i) || this._study.isBgColorerPlot(i))
            ...
            for (var l = 0; l < r.length; l++)
              if (
                r[l].target === o &&
                (this._study.isSelfColorerPlot(l) || this._study.isOHLCColorerPlot(l))
              ) {
        ...
        (x.prototype._prepareFilledAreaBackground = function (e, t, i, o, n) {
          ...
          var l = $("<input type='checkbox' class='visibility-switch'/>");
          l.appendTo(r),
            this.createLabeledCell(o, l).appendTo(a).addClass('propertypage-name-label');
          var s = $('<td/>');
          s.appendTo(a), s.addClass('colorpicker-cell');
          var d = C(s);
          return (
        ...
        (x._createRow_horizlines = function (e, t) {
          ...
          $('<td>').append(n).appendTo(i),
            ...
            this.bindControl(
              new d(l, t.style, parseInt, !0, this.model(), 'Change ' + o + ' style'),
            ),
        ...
        (x._createRow_hlines = function (e, t) {
          ...
          if (
            ...
            this.bindControl(new b(r, t.width, !0, this.model(), 'Change ' + o + ' width')),
            this.bindControl(
              new p(s, t.showPrice, !0, this.model(), 'Change ' + o + ' show price'),
            ),
            t.enableText.value())
          ) {
            i = this.addRow(e);
            ...
            $('<td class="text-center">').append(h).appendTo(i),
              ...
              this.bindControl(
                new p(h, t.showText, !0, this.model(), 'Change ' + o + ' show text'),
              );
            var u = TradingView.createTextPosEditor();
            $('<td>').append(u.render()).appendTo(i),
              this.bindControl(
                new d(u, t.textPos, parseInt, !0, this.model(), 'Change ' + o + ' text position'),
              );
            var C = this.createFontSizeEditor();
            $('<td colspan="2">').append(C).appendTo(i),
              this.bindControl(
                new d(C, t.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size'),
              );
          }
        }),
        (x._createRow_hhists = function (e, t) {
          ...
          $('<td>').append(y).appendTo(s),
            this.bindControl(
              new d(y, t.direction, null, !0, this.model(), 'Change ' + i + ' Placement'),
            );
          s = this.addRow(e);
          ...
          $('<td>').append(g).appendTo(s),
            ...
            this.bindControl(
              new p(g, t.showValues, !0, this.model(), 'Change ' + i + ' Show Values'),
            );
          s = this.addRow(e);
          ...
          this.bindControl(
            new c(w, t.valuesColor, !0, this.model(), 'Change ' + i + ' Text Color'),
          ),
          t.colors))
            if (isNumber(parseInt(_, 10))) {
              ...
              (o[_] = t.titles[_].value()),
                ...
                this.bindControl(
                  new c(n[_], t.colors[_], !0, this.model(), 'Change ' + o[_] + ' color'),
                );
            }
        }),
        (x._createRow_backgrounds = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            ...
            this.bindControl(
              new c(a, t.color, !0, this.model(), 'Change ' + n + ' color', t.transparency),
            );
        }),
        ...
        (x._createRow_trendchannels = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            $('<td>').append(n).appendTo(i),
            this.bindControl(
              new c(n, t.color, !0, this.model(), 'Change ' + o + ' color', t.transparency),
            );
        }),
        (x._createRow_textmarks = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            ...
            this.bindControl(
              new d(l, t.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size'),
            ),
            this.bindControl(
              new d(r, t.fontFamily, null, !0, this.model(), 'Change ' + o + ' font'),
            ),
        ...
        (x._createRow_shapemarks = function (e, t) {
          ...
          r.attr('type', 'text'),
            ...
            this.bindControl(new p(o, t.visible, !0, this.model(), 'Change ' + n + ' visibility')),
            this.bindControl(
              new c(a, t.color, !0, this.model(), 'Change ' + n + ' back color', t.transparency),
            ),
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          $("<td colspan='2'>").append(B).appendTo(n),
            ...
            this.bindControl(
              new r(b, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
            ),
            this.bindControl(
              new r(
                u,
    ...
    uHqD: function (e, t, i) {
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          this.bindControl(
            new l(c, t.visible, !0, this.model(), 'Change Fib Speed Resistance Arcs Visibility'),
          ),
            this.bindControl(
              new s(y, t.color, !0, this.model(), 'Change Fib Speed Resistance Arcs Line Color', 0),
            ),
            this.bindControl(
              new d(w, t.linewidth, !0, this.model(), 'Change Fib Speed Resistance Arcs Width'),
            );
        }),
        (b.prototype.prepareLayout = function () {
          (this._table = $(document.createElement('table'))),
    ...
    y9kM: function (e, t, i) {
      ...
      inherit(p, o),
        ...
        (p.prototype.prepareLayout = function () {
          ...
          $('<td>').append(d).prependTo(p),
            this.bindControl(
              new r(d, a.showPriceLine, !0, this.model(), 'Change Price Price Line'),
            );
