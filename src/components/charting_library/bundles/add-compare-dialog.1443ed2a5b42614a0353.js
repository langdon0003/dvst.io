                    ...
                    a &&
                      ...
                      a.dataSources().forEach(function (i) {
                        if (i._metaInfo && 'Compare@tv-basicstudies' === i._metaInfo.id) {
                          ...
                          (o === t || (e._symbolAlias[o] && e._symbolAlias[o] === t)) &&
                            a.removeSource(i);
                        }
                      }));
                  }
              ...
              if (!this._options.noSlider) {
                ...
                if (
                  ...
                  if (d) {
                    ...
                    (l += parseInt(p.getPropertyValue('padding-left')) + d.offsetLeft),
                  ...
                  this._bindOneEvent({
                    ...
                    listener: function (e) {
                      var i = t.getTabsArray(),
                        ...
                        r = Object(u.isRtl)()
                          ? 0
                          : t._elScrollWrap.scrollLeft + t._getElWidth(t._elScrollWrap);
                      Object(u.isRtl)() && i.reverse(),
                        i.forEach(function (t) {
                          if (0 === s) {
                            var e = t.offsetLeft + t.offsetWidth;
                        ...
                        o().then(function () {
                          $.Velocity.animate(t._elScrollWrap, 'scroll', {
                            ...
                            easing: 'easeInOutCubic',
                            offset: Math.ceil(
                              s - r + t._getElWidth(Object(a.ensureDefined)(t._elArrowRight)),
                            ),
                            queue: !1,
                          });
                        });
