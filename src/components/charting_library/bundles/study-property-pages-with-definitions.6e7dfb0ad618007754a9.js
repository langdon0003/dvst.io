  ...
  ['study-property-pages-with-definitions'],
  {
    WUYT: function (e, t, i) {
      ...
      var y = i('zqjM'),
        ...
        f = window.t('Style'),
        v = window.t('Inputs'),
        g = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map(
          function (e) {
            return {
              value: e,
          ...
          return (
            ...
            (e.prototype._getInputSourceItems = function () {
              ...
              if (
                ...
                var p = new Set(
                  Object(n.__spreadArrays)([this._source], this._source.getAllChildren()),
                );
                this._undoModel
                  .model()
                  .allStudies()
        ...
        P = (function (e) {
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(r.k)(
                  Object(n.__spreadArrays)([t], this._getSeriesStylesDefinitions()),
                  'SeriesStyleGroup' + o,
                ),
                i,
                s,
