        ...
        x = (function () {
          ...
          return (
            ...
            (t.prototype._findWrapperForWidget = function (t) {
              for (
                var e = this._content.getElementsByClassName('js-widget'), o = 0;
                o < e.length;
                ++o
              ) {
                var i = e.item(o);
        ...
        o('m/4m'),
          ...
          (w.prototype.onToolChanged = function (t, e) {
            if (t && -1 !== t.toLowerCase().indexOf('linetool')) {
              ...
              this.selectedSources() ? this.onSourceChanged(this.selectedSources()) : this.hide();
          }),
          ...
          (w.prototype._createWidthsButton = function (t) {
            if ((t = t || this.selectedSources().filter(f)).length < 1 || !y.canCreateForSources(t))
              return !1;
              ...
              this._floatingToolbar.addGroupedWidget(
                {
                  ...
                  tooltip:
                    1 === t.length ? window.t('Line tool width') : window.t('Line tool widths'),
                },
          ...
          (w.prototype.showPropertiesOf = function (t, e) {
            ...
            if ((this._clearProperties(), (this._propertiesVisible = !1), o.length)) {
              for (var i = {}, n = o.length - 1; n >= 0; --n) {
                for (var r = o[n], s = e, a = r.name.split('.'), l = 0; l < a.length; ++l)
                  s = s && s[a[l]];
                var d = r.showIf;
          ...
          (w.prototype.colorPropertyControl = function (t, e, o) {
            ...
            return (
              ...
              n.after(r),
              this.bindControl(
                new a(i, t, !0, this.activeChartWidget().model(), null, w.getTransparency(e, o)),
              ),
