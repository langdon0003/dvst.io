  ...
  ['symbolsearch'],
  {
    ...
    m5UM: function (t, e, i) {
      ...
      (function (e) {
        ...
        function C(t, e) {
          return (
            e in t || (t[e] = 'bitcoin' === e || 'crypto' === e ? window.t('crypto') : window.t(e)),
            t[e]
          );
        }
        var k = {},
          ...
          L = (function () {
            ...
            (m.registerAutoFocus = function (t) {
              if (
                (t instanceof jQuery && (t = t.data('symbol-search-instance')), !(t instanceof m))
              )
                throw new TypeError(
              ...
              (m.prototype._moveSelection = function (t, e) {
                if (this.$list) {
                  ...
                  if (
                    r !== (i = 1 === t ? (o.get(0) === s.get(-1) ? 0 : r + t) : Math.max(-1, r + t))
                  ) {
                    var a = s.get(i);
                    if (a) {
              ...
              (m.prototype._groupContracts = function (t) {
                for (
                  var e = ChartApiInstance.futuresRegex(), i = {}, n = [], s = 0;
                  s < t.length;
                  ++s
                ) {
                  var o = t[s];
              ...
              (m.prototype._isSpreadInInput = function () {
                return (
                  this._inputParserMixin && this._state.parsed && this._state.parsed.length > 1
                );
              }),
                ...
                if (e.highlightedItem) {
                  ...
                  if (this._isSpreadInInput() || (this._inputParserMixin && !0 !== t)) {
                    ...
                    (this._state._selectedTicker = i.ticker || i.symbol),
                      ...
                      (s = (n =
                        !0 === t && i.full_name && this._inputParserMixin ? i.full_name : i.symbol)
                        .length);
              ...
              (m.createSuggestListRow = function (t, e, i, n) {
                ...
                var l = t.symbol.replace(e, '<strong>$&</strong>'),
                  c = n.nameContent || l;
                t.broker_symbol &&
                  (c = c + ' (' + t.broker_symbol.replace(e, '<strong>$&</strong>') + ')'),
                  (a.innerHTML = c);
              ...
              (m.showDialog = function (t) {
                ...
                if (!d.get('Symbol Search')) {
                  ...
                  if (
                    ...
                    t.ignoreInterval ||
                      ((n = m.getInputValueGetter(a)), (s = m.getInputValueSetter(a))),
                          ...
                          n = (function (t, e, i) {
                            ...
                            var u = s.outerHeight(),
                              ...
                              f =
                                ...
                                d / 2;
                            return (
                              o.css('maxHeight', f - d - u + 'px'), { popup: n, listWrapper: o }
                            );
                          })(C, t, i.position);
                        (_ = n.popup),
