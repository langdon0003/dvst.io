  ...
  ['chart-widget-gui'],
  {
        ...
        H = (function () {
          ...
          return (
                ...
                this._chart.withModel(this, function () {
                  ...
                  e.fullscreenable.subscribe(t._boundUpdateMaximizeButtonsVisibility),
                    ...
                    null !== t._chartBackgroundProperty &&
                      t._chartBackgroundProperty.subscribe(t, t._updateBgBarStyle),
                    t._updateBgBarStyle();
                });
            }),
            ...
            (t.prototype._visibilityMouseHandler = function (t) {
              if (
                !(t.buttons || (null !== this._chartModel && this._chartModel.lineBeingCreated()))
              ) {
            ...
            (t.prototype._moveByBar = function (t) {
              ...
              if (null !== this._chartModel) {
                ...
                if (
                  ...
                  var s =
                    i.indexToCoordinate(i.visibleBarsStrictRange().lastBar()) + i.barSpacing() / 2;
        ...
        h = (function () {
          ...
          return (
            ...
            (t.prototype._updateActionVisibilities = function (t, e) {
              Object(n.ensureNotNull)(this._listActionsElements[t]).classList.toggle(
                d.blockHidden,
                !e,
              );
            }),
    ...
    sAH5: function (t, e, i) {
      ...
      var g = (function () {
          ...
          return (
            (t.prototype.destroy = function () {
              ...
              null !== this._el) &&
                (Object(o.ensureNotNull)(this._el.parentNode).removeChild(this._el),
                (this._el = null));
            }),
            ...
            (t.prototype._updateShowLine = function () {
              null !== this._el &&
                this._el.classList.toggle(p.blockHidden, this._isRowHidden.value());
            }),
          ...
          return (
            ...
            (e.prototype._render = function () {
              ...
              this._el.appendChild(e),
                null !== this._actionsParentEl && this._el.appendChild(this._actionsParentEl);
              var i = Object(o.ensureNotNull)(this._valuesParentEl);
              this._el.appendChild(i), this._parentEl.append(this._el);
            }),
            (e.prototype._renderValues = function () {
      ...
      var it = i('z61+'),
              ...
              if (!this._options.readOnlyMode) {
                ...
                ct &&
                  ...
                  (!Object(tt.isStudy)(this._source) ||
                    new it.a(this._source.metaInfo()).hasUserEditableOptions()) &&
                  this._actions.push({
                    icon: ot,
        ...
        ft = (function () {
          ...
          return (
            ...
            (t.prototype._getTooltip = function (t) {
              ...
              return null !==
                (i =
                  null === (e = this._infoMaps.tooltipMap) || void 0 === e ? void 0 : e.get(t)) &&
                void 0 !== i
                ? i
                : null;
            }),
        ...
        Xt = Object(wt.b)(
          window.t('Real-time data for {symbolName} is provided by {exchange} exchange.'),
        ),
        Zt = Object(wt.b)(
          window.t(
      ...
      var Ke = (function () {
          ...
          return (
            ...
            (t.prototype._addVisibilitySubscriptions = function () {
              var t;
              this._options.sourceStatusesEnabled &&
                (this._isSymbolInvalid.subscribe(this._updateSymbolInvalidShow.bind(this), {
                  callWithLast: !0,
                }),
                this._isSymbolInvalid.subscribe(this._updateForceStatusActive.bind(this), {
                  callWithLast: !0,
                })),
      ...
      var gi = (function () {
        function t(t, e, i, o, n, l) {
          ...
          var c = this._model.model().properties().paneProperties.legendProperties
        ...
        return (
          ...
          (t.prototype.updateLayout = function () {
            ...
            0 !== s.length &&
              ...
              (this._dataSourceViewModels = this._dataSourceViewModels.concat(s))),
          ...
          (t.prototype._updateVisibilityNotMainSources = function () {
            this._updateLegendVisibilities(),
              this._hideNotMainSources.value() || this._updateCollapsedSourcesMode();
          }),
