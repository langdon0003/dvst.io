    ...
    IDfV: function (e, t, n) {
          ...
          function t(t) {
            ...
            if (
              ...
              (n._handleChange = function (e) {
                ...
                if (o && '' === c)
                  n.setState({ queryValue: c, isOpened: !1, active: void 0 }), a && a();
                else {
      ...
      function P(e, t, n) {
        j.backend.saveStudyTemplate(e, function (e) {
          ('error' in e && e.error) ||
            (j.backend.invalidateStudyTemplatesList(), j.backend.getStudyTemplatesList(t));
        });
      }
      var z = (function () {
        function e(e) {
    ...
    L0Sj: function (e, t, n) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e,
                ...
                S = s(
                  i.inputWrapper,
                  (((t = {})[_] = Boolean(_)), (t[i.grouped] = h), (t[i.column] = f), t),
                ),
                w = [],
                O = r.createElement(
                  'input',
      ...
      function u(e) {
        var t,
          ...
          v = s(
            c.inputWrapper,
            (((t = {})[n] = Boolean(n)), (t[c.iconed] = Boolean(u)), (t[c.clearable] = p), t),
          );
