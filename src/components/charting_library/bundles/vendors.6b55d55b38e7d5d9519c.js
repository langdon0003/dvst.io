  ...
  ['vendors'],
  {
                      ...
                      l(n, function (t, n) {
                        (e.cssHooks[n] = {
                          ...
                          (e.fx.step[n] = function (t) {
                            t.colorInit ||
                              ((t.start = i(t.elem, n)), (t.end = i(t.end)), (t.colorInit = !0)),
                ...
                (function () {
                  ...
                  function i(t) {
                    ...
                    if (o && o.length && o[0] && o[o[0]])
                      for (r = o.length; r--; )
                        'string' == typeof o[(n = o[r])] && (i[e.camelCase(n)] = o[n]);
                              ...
                              (this.diff = (function (t, n) {
                                ...
                                for (r in n)
                                  (i = n[r]),
                                    t[r] !== i &&
                                      (o[r] ||
                                        (!e.fx.step[r] && isNaN(parseFloat(i))) ||
                                        (s[r] = i));
                                return s;
                              })(this.start, this.end)),
                              this
        ...
        return (
          (e.prototype.getLanguagePartFromCode = function (e) {
            ...
            return this.formatLanguageCode(
              ['NB-NO', 'NN-NO', 'nb-NO', 'nn-NO', 'nb-no', 'nn-no'].indexOf(e) > -1
                ? t[1].toLowerCase()
                : t[0],
            );
          }),
      ...
      var w = (function (e) {
        ...
        return (
          ...
          (t.prototype.init = function (e, t) {
            ...
            return (
              this.options.resources || !this.options.initImmediate ? m() : setTimeout(m, 0), this
            );
          }),
              ...
              function o(n, r) {
                var o = i.raw
                  ...
                  : (function (e) {
                      ...
                      try {
                        return (
                          (e = decodeURIComponent(e.replace(t, ' '))), i.json ? JSON.parse(e) : e
                        );
                      } catch (n) {}
                    })(n);
          ...
          (i.manipulateListeners = function (e, t, n) {
            ...
            if ('object' != typeof t || t instanceof RegExp)
              ...
              for (r in t)
                t.hasOwnProperty(r) &&
                  (o = t[r]) &&
                  ('function' == typeof o ? i.call(this, r, o) : s.call(this, r, o));
            return this;
          }),
          ...
          (e.prototype.nest = function (e, t) {
            ...
            for (s.applyPostProcessor = !1; (r = this.nestingRegexp.exec(e)); )
              'string' != typeof (i = t(u.call(this, r[1].trim()), s)) && (i = o.makeString(i)),
                i ||
                  (this.logger.warn(
                    'missed to pass in variable ' + r[1] + ' for interpolating ' + e,
                  ),
                  (i = '')),
              ...
              ? a.allowMultiLoading && this.backend.readMulti
                ...
                : ((u = function (e) {
                    ...
                    this.read(i, s, 'read', null, null, function (n, r) {
                      n &&
                        t.logger.warn(
                          'loading namespace ' + s + ' for language ' + i + ' failed',
                          n,
                        ),
              ...
              a.allowMultiLoading && this.backend.readMulti
                ...
                : ((s = function (e) {
                    ...
                    this.read(i, s, 'read', null, null, function (n, r) {
                      n &&
                        t.logger.warn(
                          'reloading namespace ' + s + ' for language ' + i + ' failed',
                          n,
                        ),
                        !n &&
                          r &&
                          t.logger.log('reloaded namespace ' + s + ' for language ' + i, r),
                        t.loaded(e, n, r);
                    });
                  }),
                  e.forEach(function (e) {
                        ...
                        left: function (e, t) {
                          ...
                          t.collisionWidth > s
                            ? u > 0 && c <= 0
                              ...
                              : (e.left =
                                  c > 0 && u <= 0 ? i : u > c ? i + s - t.collisionWidth : i)
                            : u > 0
                            ? (e.left += u)
                            : c > 0
                            ? (e.left -= c)
                        ...
                        top: function (e, t) {
                          ...
                          t.collisionHeight > s
                            ? u > 0 && c <= 0
                              ...
                              : (e.top =
                                  c > 0 && u <= 0 ? i : u > c ? i + s - t.collisionHeight : i)
                            : u > 0
                            ? (e.top += u)
                            : c > 0
                            ? (e.top -= c)
                        ...
                        left: function (e, t) {
                          ...
                          l < 0
                            ? ((n = e.left + d + p + h + t.collisionWidth - a - s) < 0 ||
                              ...
                              (e.left += d + p + h)
                            : f > 0 &&
                              ((o = e.left - t.collisionPosition.marginLeft + d + p + h - u) > 0 ||
                                r(o) < f) &&
                              (e.left += d + p + h);
                        },
                        top: function (e, t) {
                          var n,
                            ...
                            h = -2 * t.offset[1];
                          l < 0
                            ? ((o = e.top + d + p + h + t.collisionHeight - a - s) < 0 ||
                                o < r(l)) &&
                              (e.top += d + p + h)
                            : f > 0 &&
                              ((n = e.top - t.collisionPosition.marginTop + d + p + h - u) > 0 ||
                                r(n) < f) &&
                              (e.top += d + p + h);
                        },
                      },
              ...
              u.forEach(function (o) {
                if (void 0 !== (n = r[o])) {
                  ...
                  i.hasOwnProperty(e) || (i[e] = []),
                    ((Array.isArray(t) && ~t.indexOf(e)) || e in t) && i[e].push(o);
                }
              });
            }),
                              ...
                              return 'instance' === i
                                ...
                                ? e.isFunction(r[i]) && '_' !== i.charAt(0)
                                  ? (n = r[i].apply(r, a)) !== r && void 0 !== n
                                    ...
                                    : void 0
                                  : e.error(
                                      "no such method '" + i + "' for " + t + ' widget instance',
                                    )
                                : e.error(
                  ...
                  option: function (t, n) {
                    ...
                    if ('string' == typeof t)
                      if (((s = {}), (r = t.split('.')), (t = r.shift()), r.length)) {
                        for (
                          o = s[t] = e.widget.extend({}, this.options[t]), i = 0;
                          i < r.length - 1;
                          i++
                        )
                          (o[r[i]] = o[r[i]] || {}), (o = o[r[i]]);
                    ...
                    'boolean' != typeof t && ((r = n), (n = t), (t = !1)),
                      ...
                      e.each(r, function (r, s) {
                        function a() {
                          if (
                            t ||
                            (!0 !== i.options.disabled && !e(this).hasClass('ui-state-disabled'))
                          )
        ...
        'Array',
        {
          from: function (e) {
            var t,
              ...
              y = l(d);
            if (
              (v && (g = r(g, h > 2 ? arguments[2] : void 0, 2)), null == y || (p == Array && a(y)))
            )
    ...
    P5fv: function (e, t) {
        ...
        i = (function () {
          ...
          return (
            ...
            s.extend({
              ...
              bindReady: function () {
                if (!o) {
                  if (((o = s.Callbacks('once memory')), 'complete' === n.readyState))
      ...
      i.Callbacks = function (e) {
        ...
        var t,
          ...
          d = function (i, s) {
            for (
              s = s || [], t = !e.memory || [i, s], n = !0, r = !0, u = o || 0, o = 0, a = c.length;
              c && u < a;
              u++
            )
              ...
              if (c)
                for (var t = arguments, n = 0, o = t.length; n < o; n++)
                  for (
                    ...
                    i < c.length &&
                    (t[n] !== c[i] ||
                      (r && i <= a && (a--, i <= u && u--), c.splice(i--, 1), !e.unique));
                    i++
                  );
              return this;
            },
          ...
          if ('string' == typeof (n = e.getAttribute(r))) {
            try {
              n =
                'true' === n ||
                ('false' !== n &&
                  ('null' === n ? null : i.isNumeric(n) ? +n : u.test(n) ? i.parseJSON(n) : n));
            } catch (o) {}
            i.data(e, t, n);
          } else n = void 0;
        }
          ...
          if (i.acceptData(e)) {
            ...
            if ((d && f[d] && (p || r || f[d].data)) || !c || void 0 !== n)
              return (
                ...
                p && !s[t]
                  ? o.events
                  : (c ? null == (a = s[t]) && (a = s[i.camelCase(t)]) : (a = s), a)
              );
          }
        },
        ...
        i.fn.extend({
          data: function (e, t) {
            ...
            if (void 0 === e) {
              if (
                this.length &&
                ((f = i.data(u)), 1 === u.nodeType && !i._data(u, 'parsedAttrs'))
              ) {
          ...
          if ((e && 'string' == typeof e) || void 0 === e)
            for (t = (e || '').split(m), n = 0, r = this.length; n < r; n++)
              if (1 === (o = this[n]).nodeType && o.className)
                if (e) {
                  for (
                    s = (' ' + o.className + ' ').replace(v, ' '), a = 0, u = t.length;
                    a < u;
                    a++
                  )
                    s = s.replace(' ' + t[a] + ' ', ' ');
            ...
            : this.each(function () {
                if ('string' === n)
                  ...
                  ('undefined' !== n && 'boolean' !== n) ||
                    ...
                    (this.className =
                      this.className || !1 === e ? '' : i._data(this, '__className__') || ''));
              });
        },
        hasClass: function (e) {
        ...
        S ||
          ...
          (p = i.valHooks.button = {
            ...
            set: function (e, t, r) {
              ...
              return (
                o || ((o = n.createAttribute(r)), e.setAttributeNode(o)), (o.nodeValue = t + '')
              );
            },
          }),
          ...
          if (y && (p = y.events)) {
            for (t = i.trim(L(t || '')).split(' '), s = 0; s < t.length; s++)
              if (((u = c = (a = O.exec(t[s]) || [])[1]), (l = a[2]), u)) {
                ...
                0 === v.length &&
                  f !== v.length &&
                  ((h.teardown && !1 !== h.teardown.call(e, l)) || i.removeEvent(e, u, y.handle),
                  delete p[u]);
              } else for (u in p) i.event.remove(e, u + t[s], n, r, !0);
            i.isEmptyObject(p) &&
              ((g = y.handle) && (g.elem = null), i.removeData(e, ['events', 'handle'], !0));
          }
        },
              ...
              if (
                ...
                if (
                  ...
                  if (((p = [[n, f.bindType || g]]), !r && !f.noBubble && !i.isWindow(n))) {
                    for (
                      h = f.delegateType || g, u = C.test(h + g) ? n : n.parentNode, c = null;
                      u;
                      u = u.parentNode
                    )
                      p.push([u, h]), (c = u);
                  ...
                  for (a = 0; a < p.length && !e.isPropagationStopped(); a++)
                    (u = p[a][0]),
                      (e.type = p[a][1]),
                      (d = (i._data(u, 'events') || {})[e.type] && i._data(u, 'handle')) &&
                        d.apply(u, t),
                      (d = l && u[l]) &&
                        i.acceptData(u) &&
                        !1 === d.apply(u, t) &&
                ...
                for (a in (o = i.cache))
                  o[a].events && o[a].events[g] && i.event.trigger(e, t, o[a].handle.elem, !0);
          }
        },
        dispatch: function (e) {
              ...
              for (
                ...
                (l = u.matches[n]),
                  (g ||
                    ...
                    (e.handleObj = l),
                    void 0 !==
                      (s = ((i.event.special[l.origType] || {}).handle || l.handler).apply(
                        u.elem,
                        h,
                      )) &&
            ...
            if ((l || (l = c), l || f.error(v || t), '[object Array]' === o.call(l)))
              if (b)
                if (r && 1 === r.nodeType)
                  for (y = 0; null != l[y]; y++)
                    l[y] &&
                      (!0 === l[y] || (1 === l[y].nodeType && f.contains(r, l[y]))) &&
                      i.push(c[y]);
                    ...
                    if (((r = r || n), !i && !f.isXML(r))) {
                      ...
                      if (9 === r.nodeType) {
                        ...
                        var u = r,
                          ...
                          d = r.parentNode,
                          h = /^\s*[+~]/.test(t);
                        c ? (l = l.replace(/'/g, '\\$&')) : r.setAttribute('id', l),
                          h && d && (r = r.parentNode);
                        try {
      ...
      i.fn.extend({
        ...
        i.extend({
          ...
          dir: function (e, t, n) {
            for (
              var r = [], o = e[t];
              o && 9 !== o.nodeType && (void 0 === n || 1 !== o.nodeType || !i(o).is(n));
              ...
              c.length &&
                i.each(c, function (e, t) {
                  t.src
                    ...
                    : i.globalEval(
                        (t.text || t.textContent || t.innerHTML || '').replace(oe, '/*$0*/'),
                      ),
        ...
        i.each(
          ...
          function (e, t) {
            i.fn[e] = function (n) {
              ...
              if (s && 11 === s.nodeType && 1 === s.childNodes.length && 1 === o.length)
          ...
          cleanData: function (e) {
            for (
              ...
              if ((!r.nodeName || !i.noData[r.nodeName.toLowerCase()]) && (n = r[i.expando])) {
                ...
                a ? delete r[i.expando] : r.removeAttribute && r.removeAttribute(i.expando),
                  delete o[n];
              }
          },
        });
          ...
          ((i.expr.filters.hidden = function (e) {
            ...
            return (
              ...
              (!i.support.reliableHiddenOffsets &&
                'none' === ((e.style && e.style.display) || i.css(e, 'display')))
            );
          }),
            ...
            function w(e, t, o, u) {
              if (2 !== b) {
                ...
                (_.status = e),
                  ...
                  g.fireWith(d, [_, S]),
                  c &&
                    (p.trigger('ajaxComplete', [_, f]), --i.active || i.event.trigger('ajaxStop'));
              }
            }
            if (
              (h.promise(_),
                    ...
                    (t = function (n, s) {
                      ...
                      try {
                        if (t && (s || 4 === a.readyState))
                          if (
                            ((t = void 0),
                            o && ((a.onreadystatechange = i.noop), et && delete Ge[o]),
                            s)
                          )
          ...
          function s() {
            ...
            for (r in (null != h.overflow && (this.style.overflow = 'hidden'), e))
              (s = new i.fx(this, h, r)),
                ...
                ut.test(n)
                  ? (p =
                      i._data(this, 'toggle' + r) || ('toggle' === n ? (v ? 'show' : 'hide') : 0))
          ...
          return (
            ...
            this.each(function () {
              ...
              if ((n || i._unmark(!0, this), null == e))
                for (t in s)
                  s[t] && s[t].stop && t.indexOf('.run') === t.length - 4 && a(this, s, t);
    ...
    'W+In': function (e, t, n) {
      var r = n('vVR7'),
        ...
        f = (l.trim = function (e, t) {
          return (
            (e = String(o(e))), 1 & t && (e = e.replace(u, '')), 2 & t && (e = e.replace(c, '')), e
          );
        });
      e.exports = l;
    },
    ...
    YFKU: function (e, t, n) {
      ...
      if (!window.__tradingviewI18nextInited) {
        var l = window.language || null,
          f = h(l);
        if (
          ((l && f) || (console.error('No translation data'), (l = 'en'), (f = h('en'))), l && f)
        ) {
          var d = {
        ...
        return (
          ...
          (t.prototype.translate = function (e) {
            ...
            if (f && 'string' != typeof f && p.indexOf(d) < 0 && (!h || '[object Array]' !== d)) {
              ...
              for (var v in f)
                g[v] = this.translate('' + a + i + v, r({ joinArrays: !1, ns: c }, t));
              f = g;
    ...
    bf9a: function (e, t, n) {
      ...
      var r = (window.Modernizr = (function (e, t, n) {
        ...
        var c,
          ...
          S = function (e, n, r, o) {
            ...
            if (parseInt(r, 10))
              for (; r--; )
                ((a = t.createElement('div')).id = o ? o[r] : p + (r + 1)), c.appendChild(a);
            return (
      ...
      r.addTest('mobiletouch', r.touchevents && 'onorientationchange' in window),
        r.addTest(
          'touch',
          r.touchevents || !!navigator.maxTouchPoints || !!navigator.msMaxTouchPoints,
        ),
        r.addTest('pointerevents', function () {
          ...
          if (
            ((e.style.pointerEvents = 'auto'), (e.style.pointerEvents = 'x'), t.appendChild(e), n)
          ) {
            var o = n(e, '');
    ...
    lPLC: function (e, t, n) {
      ...
      (r = jQuery),
        ...
        (s = function (e) {
          ...
          t.localScroll
            ? e.target.scrollTop >
                e.target.scrollHeight - r(e.target).height() - (t.tolerance || 190) &&
              r(this).trigger('scrolltoend')
            : o.scrollTop() > i.height() - o.innerHeight() - (t.tolerance || 190) &&
              r(this).trigger('scrolltoend');
        }),
        ...
        'undefined' != typeof window
          ...
          (t.clone = function (e) {
            ...
            for (r in ((n = 'function' == typeof e.pop ? [] : {}), e))
              e.hasOwnProperty(r) &&
                ((o = e[r]), (n[r] = o && 'object' == typeof o ? t.clone(o) : o));
            return n;
          }),
          (t.deepEquals = function (e, r, o) {
            if ((o || (o = ''), e === r)) return [!0, o];
            if ((i(e) && (e = void 0), i(r) && (r = void 0), void 0 === e && void 0 !== r))
              return [!1, o];
          ...
          (t.merge = function (e, n) {
            for (var r in n)
              'object' == typeof n[r] && e.hasOwnProperty(r) ? t.merge(e[r], n[r]) : (e[r] = n[r]);
            return e;
          }),
              ...
              var a = (e.event.special.mousewheel = {
                ...
                setup: function () {
                  if (this.addEventListener)
                    for (var t = o.length; t; ) this.addEventListener(o[--t], u, !1);
                ...
                teardown: function () {
                  if (this.removeEventListener)
                    for (var t = o.length; t; ) this.removeEventListener(o[--t], u, !1);
      ...
      var f = (function (e) {
        ...
        return (
          ...
          (t.prototype.addResource = function (e, t, n, r) {
            var o =
                arguments.length <= 4 || void 0 === arguments[4] ? { silent: !1 } : arguments[4],
