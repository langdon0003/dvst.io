      ...
      (function () {
        ...
        (g.each = g.forEach = function (n, t, r) {
          ...
          (g.find = g.detect = function (n, t, r) {
            var e;
            if (void 0 !== (e = O(n) ? g.findIndex(n, t, r) : g.findKey(n, t, r)) && -1 !== e)
              return n[e];
          }),
          ...
          (g.max = function (n, t, r) {
            var e,
              ...
              o = -1 / 0;
            if (null == t && null != n)
              for (var a = 0, c = (n = O(n) ? n : g.values(n)).length; a < c; a++)
                (e = n[a]) > u && (u = e);
            else
              (t = b(t, r)),
        ...
        (g.groupBy = A(function (n, t, r) {
          ...
          (g.last = function (n, t, r) {
            if (null != n)
              return null == t || r ? n[n.length - 1] : g.rest(n, Math.max(0, n.length - t));
          }),
        ...
        (g.flatten = function (n, t) {
          ...
          (g.unzip = function (n) {
            for (var t = (n && g.max(n, j).length) || 0, r = Array(t), e = 0; e < t; e++)
              r[e] = g.pluck(n, e);
            return r;
          }),
        ...
        (g.keys = function (n) {
          ...
          (g.pairs = function (n) {
            for (var t = g.keys(n), r = t.length, e = Array(r), i = 0; i < r; i++)
              e[i] = [t[i], n[t[i]]];
            return e;
          }),
          (g.invert = function (n) {
