  ...
  ['lt-pane-views'],
  {
      ...
      inherit(c, n),
        ...
        (c.prototype._updateRenderer = function () {
          if (!((S = this._points).length < 2)) {
            ...
            if (
              (this._baseTrendRenderer.setData(n), e.append(this._baseTrendRenderer), S.length < 3)
            )
            ...
            for (
              var _ = this._model._fibWedgeLabelsCache, f = _.canvas(), v = this._levels.length - 1;
              v >= 0;
              v--
            ) {
    ...
    '2hKl': function (e, t, i) {
      ...
      function n(e, t, i, r, n) {
        for (
          var a = 3 / (i.subtract(e).length() + r.subtract(i).length() + t.subtract(r).length()),
            s = 0;
          s <= 1;
          s += a
        ) {
      ...
      function a(e, t, i, r, n) {
        ...
        var l = (function (e, t, i, r, n) {
          for (
            var a = [], l = s(e.y, t.y, i.y, 0).concat(s(e.y, t.y, i.y, n)), h = 0;
            h < l.length;
            h++
          ) {
      ...
      inherit(p, c),
        ...
        (p.prototype.hitTest = function (e) {
          if (null !== this._data && 3 === this._data.points.length) {
            ...
            if (d.quadroBezierHitTest(r, t, a, e) || d.quadroBezierHitTest(r, i, o, e))
        ...
        (f.prototype._updateImpl = function () {
          ...
          if (!(this._points.length < 2)) {
            ...
            this._source._controlPoint &&
              c.push(this._source.pointToScreenPoint(this._source._controlPoint)[0]);
            var p = {},
        ...
        (d.prototype._updateBaseData = function () {
          ...
          this._source.points().length >= 3 &&
            ...
            this._source.points().length >= 5 &&
              ...
              (this._CDRetracement =
                Math.round(1e3 * Math.abs((n.price - r.price) / (r.price - i.price))) / 1e3),
              (this._XDRetracement =
                Math.round(1e3 * Math.abs((n.price - t.price) / (t.price - e.price))) / 1e3));
        }),
        (d.prototype._updateImpl = function () {
          if (
      ...
      inherit(T, m),
        ...
        (T.prototype.targetLabelHitTest = function (e) {
          ...
          var i = 'up' === this._data.direction ? -1 : 1,
            ...
            h = Math.min(o, l),
            d = Math.max(o, l);
          return e.x >= a && e.x <= a + this._targetWidth && e.y >= h && e.y <= d
            ? new s(s.MOVEPOINT)
            : null;
        }),
        (T.prototype.sourceLabelHitTest = function (e) {
          ...
          var t = 'up' === this._data.direction ? 1 : -1,
            ...
            l = Math.min(a, o),
            h = Math.max(a, o);
          return e.x >= n && e.x <= n + this._sourceWidth && e.y >= l && e.y <= h
            ? new s(s.MOVEPOINT)
            : null;
        }),
        (T.prototype.hitTest = function (e) {
          ...
          if (
            ...
            if (h && l) {
              (this._targetLine4 = new c().format(h)),
                d ||
                  (this._targetLine4 =
                    this._targetLine4 + '  ' + new p(_ ? '%h:%m:%s' : '%h:%m').format(h));
            ...
            g &&
              ...
              d ||
                (this._sourceLine2 =
                  this._sourceLine2 + ' ' + new p(_ ? '%h:%m:%s' : '%h:%m').format(g))),
      ...
      inherit(u, p),
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            (i.x =
              this._points[0].x + this._source._barOffset * this._model.timeScale().barSpacing()),
              t.points.push(i),
    ...
    BSCN: function (e, t, i) {
      ...
      inherit(h, n),
        ...
        (h.prototype._updateImpl = function () {
          if (
            (n.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)
          ) {
            var e = this._source.properties(),
              t = {};
            ...
            if (1 === this._points.length) {
              ...
              (_.data = 0),
                (_.square = !0),
                i.append(this.createLineAnchor({ points: [_], pointsCursorType: l }));
            }
            this._renderer = i;
          }
        }),
    ...
    'Dz+H': function (e, t, i) {
      ...
      (m.prototype.update = function (e) {
        ...
        (m.prototype.drawOn = function (e) {
          var t = new n(Math.round(this._data.point.x), Math.round(this._data.point.y)).add(
            this._translate,
          );
        ...
        (x.prototype.drawTooltipOn = function (e) {
          ...
          d < 10 ? (d = n.y + 13) : (f = 'bottom'),
            ...
            c ||
              'bottom' !== f ||
              (e.lineTo(v + 7, d + o), e.lineTo(v, d + o + 7), e.lineTo(v - 7, d + o)),
            e.lineTo(h, d + o),
            e.closePath(),
            e.fill(),
            e.stroke(),
      ...
      inherit(p, n),
        (p.prototype._updateImpl = function () {
          if (
            ...
            this._levels = [];
            for (
              var h = this._source.properties(), p = this._source.levelsCount(), u = 1;
              u <= p;
              u++
            ) {
              var _ = h['level' + u];
    ...
    Hyqq: function (e, t, i) {
      ...
      inherit(f, _),
        ...
        (f.prototype.hitTest = function (e) {
          if (null === this._data || 0 === this._data.points.length || !this._measureCache.padding)
            return null;
          var t = this._data.points[0].x - (this._measureCache.padding.left + 20),
            i = this._data.points[0].y - (this._measureCache.innerHeight + 9),
            r = a(
              new n(t, i),
              new n(t + this._measureCache.innerWidth, i + this._measureCache.innerHeight),
            );
    ...
    LMGK: function (e, t, i) {
      ...
      inherit(c, d),
        ...
        (c.prototype._drawMovePoints = function (e, t, i) {
          ...
          for (
            var r = t + 4, n = r + 2, a = Math.floor((this._height() - 10) / 2) + 1, s = 0;
            s < a;
            ++s
          ) {
            var o = i + 5 + 2 * s;
        ...
        (c.prototype.hitTest = function (e) {
          ...
          if (this._adapter._blocked && e.x >= this._cache.left && e.x < this._cache.right)
        ...
        p = (function (e) {
          ...
          return (
            ...
            (t.prototype._extendAndHitTestLineSegment = function (e, t, i, r) {
              var n = this._extendAndClipLineSegment(t, i, r);
              if (null !== n && Object(s.distanceToSegment)(n[0], n[1], e).distance <= 3)
                      ...
                      switch (C.horzLabelsAlign.value()) {
                        ...
                        case 'right':
                          C.extendLines.value()
                            ...
                            : (((Y = new r(D + 4, this._levels[R].y)).x += G.width),
                              (Y.x = Math.round(Y.x)));
                      }
                      var Z = {
                          left: G.left,
      ...
      inherit(d, r),
        ...
        (d.prototype._updateImpl = function () {
          ...
          if (this._source.points().length >= 6) {
            ...
            this._retrace2 =
              Math.round(100 * Math.abs((o.price - a.price) / (a.price - i.price))) / 100;
          }
          if (!(this._points.length < 2)) {
            for (
        ...
        (g.prototype._updateImpl = function () {
          if (
            ...
            B &&
              ...
              ((this._pipFormatter = new p(B.pricescale, B.minmov, B.type, B.minmove2)),
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            T &&
              ...
              ((this._pipFormatter = new c(T.pricescale, T.minmov, T.type, T.minmove2)),
            ...
            for (var c = (l % 2) / 2, _ = 0, f = i; _ < f.length; _++) {
              ...
              if (!(Object(d.isInteger)(v.data) && this._data.linePointBeingEdited === v.data))
                if (
                  (r(
                    e,
                    new u(Math.round(v.x * t) + c, Math.round(v.y * t) + c, v.data, v.square),
                    h / 2,
                    o,
                  ),
      ...
      inherit(h, l),
        ...
        (h.prototype._drawImpl = function (e) {
          null !== this._data &&
            ...
            e.stroke(),
            this._data.fillBackground &&
              ((e.fillStyle = o.generateColor(this._data.backcolor, this._data.transparency)),
              e.fill()));
        }),
        (h.prototype.hitTest = function (e) {
      ...
      inherit(u, p),
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            this._levels = [];
            for (
              var s = this._source.properties(), d = this._source.levelsCount(), p = 1;
              p <= d;
              p++
            ) {
              var _ = s['level' + p];
          ...
          if (
            ...
            if (this._pattern && 2 === this._source.points().length) {
              ...
              (f = parseInt(this._source.properties().mode.value(), 10)),
                (w = Math.abs(
                  (this._points[0].x - this._points[1].x) / (this._pattern.length - 1),
                ));
        ...
        (d.prototype._updateImpl = function () {
          if (
            ...
            if (1 === this._points.length) {
              ...
              (p.data = 0),
                (p.square = !0),
                e.append(this.createLineAnchor({ points: [p], pointsCursorType: h }));
            }
            this._renderer = e;
          }
        }),
    ...
    dKqZ: function (e, t, i) {
      ...
      inherit(g, f),
        ...
        (y.prototype._updateImpl = function () {
          if (
            (d.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)
          ) {
            var e = {};
            (e.points = this._points),
              (e.color = this._source.properties().color.value()),
        ...
        (n.prototype._updateBaseData = function () {
          ...
          this._source.points().length >= 3 &&
            ...
            this._source.points().length >= 4 &&
              ((r = this._source.points()[3]),
              (this._BCRetracement =
                Math.round(1e3 * Math.abs((r.price - e.price) / (t.price - e.price))) / 1e3)),
            this._source.points().length >= 5 &&
              ((n = this._source.points()[4]),
              (this._CDRetracement =
                Math.round(1e3 * Math.abs((n.price - r.price) / (r.price - i.price))) / 1e3),
              (this._XDRetracement =
                Math.round(1e3 * Math.abs((n.price - r.price) / (e.price - r.price))) / 1e3));
        }),
        (t.CypherPaneView = n);
    },
    mr3a: function (e, t, i) {
              ...
              if (i && !i.isEmpty()) {
                ...
                if (
                  ...
                  t.isPriceDencityLog() &&
                    !i.isLog() &&
                    (f =
                      i.height() / (Object(c.toLog)(u.maxValue()) - Object(c.toLog)(u.minValue()))),
                    !t.isPriceDencityLog() &&
                      i.isLog() &&
                      (f =
                        i.height() /
                        (Object(c.fromLog)(u.maxValue()) - Object(c.fromLog)(u.minValue())));
        ...
        (g.prototype._drawImpl = function (e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            (w = h(m, w)),
              ...
              e.stroke(),
              this._data.fillBackground &&
                ((e.fillStyle = u.generateColor(this._data.backcolor, this._data.transparency)),
                e.fill());
          }
        }),
          ...
          if (this._labelDataInvalidated) {
            ...
            if (c.showPriceRange.value() && this._source.priceScale()) {
              ...
              v &&
                ...
                ((this._pipFormatter = new d(v.pricescale, v.minmov, v.type, v.minmove2)),
            ...
            if (g || m || x) {
              if (
                ((t = ''), g && ((a = l.index - o.index), (t += $.t('{0} bars').format(y(a)))), m)
              ) {
    ...
    piZW: function (e, t, i) {
      ...
      inherit(l, o),
        ...
        (l.prototype.hitTest = function (e) {
          if (e.x < this._data.point.x || e.x > this._data.point.x + 2 * this._data.width)
            return null;
        ...
        (w.prototype._updateImpl = function () {
          ...
          if (
            ...
            if (i) {
              ...
              this._pl =
                this._source.points().length > 1 ? this._source.calculatePL(i.closePrice) : 0;
              ...
              if (
                ...
                if (
                  ...
                  ((C = {}).points = [b, R]),
                    ...
                    (C.fillBackground = !0);
                  var S =
                    100 - 100 * (1 - (T = 0.01 * c.stopBackgroundTransparency.value()) * T * T);
                  (C.transparency = S),
                ...
                if (
                  ...
                  var T,
                    P =
                      100 - 100 * (1 - (T = 0.01 * c.profitBackgroundTransparency.value()) * T * T);
                  (C.transparency = P),
                ...
                q &&
                  ...
                  ((this._pipFormatter = new p(q.pricescale, q.minmov, q.type, q.minmove2)),
            ...
            if (null !== this._model.timeScale().visibleBarsStrictRange()) {
              ...
              for (var l = m ? m.index - e.index : 1, p = 1; p <= 11; p++) {
                ...
                if (u.visible.value()) {
                  ...
                  t.showLabels.value() &&
                    ((f.text = u.coeff.value()), (f.y = this._source.priceScale().height())),
                    this._levels.push(f);
                }
              }
    ...
    'y/56': function (e, t, i) {
      ...
      var c = (function (e) {
        function t() {
          var t = (null !== e && e.apply(this, arguments)) || this;
          return (
            (t._flagMarkRenderer = new d()), (t._renderer = null), (t._anchorsOffset = null), t
          );
        }
        return (
          Object(r.__extends)(t, e),
