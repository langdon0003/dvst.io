        ...
        (b.prototype.model = function () {
          ...
          (V.prototype.value = function () {
            ...
            return (
              i <= e && (e = i - 1),
              1e3 *
                n(this._mainSeries.bars().valueAt(n(this._mainSeries.bars().lastIndex()) - e))[
                ...
                _refreshValue: function () {
                  ...
                  this._hasMultipleValues()
                    ? this.handles.each(function (o) {
                        (i =
                          ((l.values(o) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
        ...
        return (
          ...
          (t.prototype.initEvents = function () {
            var t = this.$el.prop('ownerDocument'),
              ...
              i = function (o) {
                return (
                  $(t).off('mousemove mouseup', e), $(t).off('mouseup', i), this.mouseupHandler(o)
                );
              }.bind(this);
            this.$el.on(
              'mousedown',
                  ...
                  if (o instanceof s.TabGroup) {
                    ...
                    if (o.date)
                      ...
                      !0 === a.svg && o.svg
                        ? (a.wrapIcon
                            ? d.append(
                                $('<span class="icon-wrap">').addClass(o.iconClass).append(o.svg),
                              )
                            : d.append(o.svg),
                          (f = $('<span class="title"></span>').appendTo(d)))
                        : o.iconClass
                    ...
                    if (
                      (o.shortcut && _.text(o.shortcut.keys), 'function' == typeof o.deleteAction)
                    ) {
              ...
              case 'left':
                (F = Math.max(F, 4)),
                  'right' === L
                    ...
                    : k
                        .css('left', Math.floor(Math.max(E.left - O - F, D)) + 'px')
                        .css('right', 'auto'),
                  H
      ...
      !(function (t) {
        ...
        function b(y) {
          ...
          function x(i) {
            ...
            function G(e) {
              1 == e.which &&
                ((L = !1), t(_).unbind('mouseup', G), b.is('.opened') && t(r).get(0).focus());
            }
            function U() {
