        ...
        f = (function (e) {
          ...
          return (
            ...
            (t.prototype._addPassiveListenerOnWheel = function (e) {
              Object(a.ensureNotNull)(this._container).addEventListener('wheel', e, {
                passive: !1,
              });
            }),
      ...
      !(function (o) {
        ...
        function d(e, t, n, r) {
          ...
          if (i < o.length) {
            if (1 === n) r = o[i] >= 5;
              ...
              r = o[i] > 5 || (5 == o[i] && (r || i < 0 || void 0 !== o[i + 1] || 1 & o[i - 1]));
            else if (3 === n) r = r || !!o[0];
        ...
        (l.abs = function () {
          ...
          (l.minus = l.sub = function (e) {
            ...
            if ((c = u - p)) {
              for (
                (o = c < 0) ? ((c = -c), (r = l)) : ((p = u), (r = d)), r.reverse(), a = c;
                a--;
          ...
          (l.plus = l.add = function (e) {
            ...
            for (
              c.length - l.length < 0 && ((t = l), (l = c), (c = t)), o = l.length, i = 0;
              o;
              c[o] %= 10
            )
