      ...
      !(function (e) {
        ...
        (function (n) {
          ...
          'object' == typeof e.exports
            ? (e.exports = n())
            : void 0 === (i = 'function' == typeof (a = n) ? a.call(t, r, t, e) : a) ||
              (e.exports = i);
        })(function () {
          'use strict';
          return (function (e, t, r, a) {
            ...
            var l = (function () {
                ...
                try {
                  ...
                  return function (t, r) {
                    var a = this.length;
                    if (
                      ('number' != typeof t && (t = 0), 'number' != typeof r && (r = a), this.slice)
                    )
            ...
            var d,
              ...
              f = !1;
            if (
              (e.fn && e.fn.jquery ? ((d = e), (f = !0)) : (d = t.Velocity.Utilities), n <= 8 && !f)
            )
              throw new Error(
                ...
                Normalizations: {
                  ...
                  register: function () {
                    ...
                    function r(e, t, r) {
                      if (
                        ('border-box' ===
                          h.getPropertyValue(t, 'boxSizing').toString().toLowerCase()) ===
                        (r || !1)
                      ) {
                        var a,
                          i,
                    ...
                    if (n <= 8) a = d.css(e, r);
                      ...
                      if (!i) {
                        if (
                          'height' === r &&
                          'border-box' !==
                            h.getPropertyValue(e, 'boxSizing').toString().toLowerCase()
                        ) {
                          var c =
                            e.offsetHeight -
                  ...
                  if ((n || (g.State.isAndroid && !g.State.isChrome)) && r && r.isSVG) {
                    var a = function (t) {
                      ...
                      i = {
                        ...
                        skewY: [a('skewY')],
                        scale:
                          1 !== a('scale') ? [a('scale'), a('scale')] : [a('scaleX'), a('scaleY')],
                  ...
                  switch (l) {
                              ...
                              d.each(s, function (r, n) {
                                if (n === a)
                                  if (
                                    ...
                                    ('finish' !== l && 'finishAll' !== l) || (t[2].duration = 1);
                              });
                            });
                        }),
                        'stop' === l &&
                    ...
                    default:
                      if (!d.isPlainObject(l) || p.isEmptyObject(l)) {
                          ...
                          return (
                            ...
                            d.each(s, function (t, r) {
                              parseFloat(e.stagger)
                                ...
                                e.drag &&
                                  ((e.duration =
                                    parseFloat(H) || (/^(callout|transition)/.test(l) ? 1e3 : 400)),
                                  (e.duration = Math.max(
                        ...
                        return (
                          v.promise ? v.rejecter(new Error(j)) : t.console && console.log(j), a()
                        );
                      }
                      b = 'start';
                  }
                      ...
                      (y = d.extend(!0, {}, m ? m.tweensContainer : null))))
                        if (y.hasOwnProperty(E) && 'element' !== E) {
                          ...
                          (y[E].startValue = y[E].currentValue = y[E].endValue),
                            ...
                            g.debug &&
                              console.log(
                                'reverse tweensContainer (' + E + '): ' + JSON.stringify(y[E]),
                                e,
                              );
                        }
                      c = y;
                        ...
                        O = function (a, n) {
                          ...
                          if (
                                  ...
                                  (function () {
                                    ...
                                    if (n && i)
                                      ...
                                      g.init(s),
                                        ...
                                        (o.percentToPxWidth = q.lastPercentToPxWidth =
                                          (parseFloat(h.getPropertyValue(s, 'width', null, !0)) ||
                                            1) / 100),
                                        (o.percentToPxHeight = q.lastPercentToPxHeight =
                                          (parseFloat(h.getPropertyValue(s, 'height', null, !0)) ||
                                            1) / 100),
                                        (o.emToPx = q.lastEmToPx =
                                          (parseFloat(h.getPropertyValue(s, 'paddingLeft')) || 1) /
                                          100),
                                    ...
                                    return (
                                      null === q.remToPx &&
                                        (q.remToPx =
                                          parseFloat(h.getPropertyValue(r.body, 'fontSize')) || 16),
                                      null === q.vwToPx &&
                                      ...
                                      (o.vhToPx = q.vhToPx),
                                      g.debug >= 1 &&
                                        console.log('Unit ratios: ' + JSON.stringify(o), e),
                                      o
                                    );
                                  })();
                                var I =
                            ...
                            (c[a] = {
                              ...
                              g.debug &&
                                console.log(
                                  'tweensContainer (' + a + '): ' + JSON.stringify(c[a]),
                                  e,
                                );
                          } else
                            g.debug &&
                            ...
                            if (((E.currentValue = F), 'tween' === A)) f = F;
                              ...
                              h.Hooks.registered[A] &&
                                (h.Normalizations.registered[j]
                                  ? (x(k).rootPropertyValueCache[j] = h.Normalizations.registered[
                                      j
                                    ]('extract', null, z[1]))
